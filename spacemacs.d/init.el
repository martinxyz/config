...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(evil-surround-pairs-alist
     '((40 "(" . ")") (91 "[" . "]") (123 "{" . "}") (41 "(" . ")") (93 "[" . "]")
       (125 "{" . "}") (35 "#{" . "}") (98 "(" . ")") (66 "{" . "}")
       (62 "<" . ">") (116 . evil-surround-read-tag) (60 . evil-surround-read-tag)
   ...
   '(projectile-other-file-alist
     '(("cpp" "h" "hpp" "ipp") ("ipp" "h" "hpp" "cpp") ("hpp" "h" "ipp" "cpp" "cc")
       ("cxx" "h" "hxx" "ixx") ("ixx" "h" "hxx" "cxx") ("hxx" "h" "ixx" "cxx")
       ("c" "h") ("m" "h") ("mm" "h")
       ("h" "c" "cc" "cpp" "ipp" "hpp" "cxx" "ixx" "hxx" "m" "mm")
       ("cc" "h" "hh" "hpp") ("hh" "cc") ("vert" "frag") ("frag" "vert")
       (nil "lock" "gpg") ("lock" "") ("gpg" "") ("html" "css" "scss" "js" "ts")
       ("ts" "html") ("js" "html") ("component.ts" "component.html")
       ("component.css" "component.html") ("component.scss" "component.html")
       ("component.spec.ts" "component.ts")
       ("component.html" "component.spec.ts" "component.css" "component.scss"
   ...
   '(yas-snippet-dirs
     '("~/.spacemacs.d/snippets" "/home/martin/.emacs.d/snippets"
