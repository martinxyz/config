...
(defun ido-sort-list-mtime (dir filelist)
  (sort filelist (lambda (a b)
                   (let ((ta (nth 5 (file-attributes (concat dir a))))
                         (tb (nth 5 (file-attributes (concat dir b)))))
...
(defun ido-make-file-list (default)
  ...
  (let ((ido-temp-list (ido-make-file-list1 ido-current-directory)))
    (setq ido-temp-list (ido-sort-list-mtime ido-current-directory ido-temp-list))
