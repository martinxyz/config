...
(defvar color-themes
  '((color-theme-aalto-dark "Aalto Dark" "Jari Aalto <jari.aalto@poboxes.com>")
    ...
    (color-theme-aliceblue "Alice Blue" "Girish Bharadwaj <GBharadwaj@Kronos.com>")
    ...
    (color-theme-xp "XP" "Girish Bharadwaj <girishb@mvps.org>"))
...
(defun color-theme-dark-maxy ()
  "Based on color-theme-dark-laptop by Laurent Michel."
  (interactive)
  (color-theme-install
   '(color-theme-dark-laptop
     ((background-color . "black")
     ...
     (fl-doc-string-face ((t (:foreground "purple"))))
     (fl-function-name-face ((t (:foreground "red"))))
     (fl-keyword-face ((t (:foreground "#47dada"))))
     (fl-string-face ((t (:foreground "green"))))
     (fl-type-face ((t (:foreground "yellow"))))

     (font-lock-builtin-face ((t (:foreground "#ffffff"))))
     (font-lock-comment-face ((t (:foreground "#cb4e39"))))
     (font-lock-constant-face ((t (:foreground "Aquamarine"))))
     (font-lock-doc-string-face ((t (:foreground "LightSalmon"))))
     (font-lock-function-name-face ((t (:foreground "LightSkyBlue"))))
     (font-lock-keyword-face ((t (:foreground "#47dada"))))
     (font-lock-preprocessor-face ((t (:foreground "Aquamarine"))))
     (font-lock-reference-face ((t (:foreground "LightSteelBlue"))))
     (font-lock-string-face ((t (:foreground "LightSalmon"))))
     (font-lock-type-face ((t (:foreground "#86dd86"))))
     (font-lock-variable-name-face ((t (:foreground "LightGoldenrod"))))
     (font-lock-warning-face ((t (:bold t :foreground "Pink"))))
     (py-pseudo-keyword-face ((t (:foreground "#47dada"))))
     ...
     (modeline-mousable ((t (:background "white" :foreground "black"))))
     (modeline-mousable-minor-mode ((t (:background "white" :foreground "black"))))
     ; (region ((t (:background "#31271f"))))
     ; (primary-selection ((t (:background "#31271f"))))
     ; (isearch ((t (:background "#7F7F33"))))
     ; (zmacs-region ((t (:background "#31271f"))))
     (secondary-selection ((t (:background "darkslateblue"))))
     (underline ((t (:underline t))))
     (widget-button-face ((t (:bold t))))
     (widget-button-pressed-face ((t (:foreground "red"))))
