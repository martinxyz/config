...
__eg_commandlist="add bisect blame branch bundle cat changes checkout cherry-pick clone commit config --debug diff gc grep help info init log merge mv publish pull push rebase remote reset resolved revert rm squash stage stash status switch tag --translate unstage update"
